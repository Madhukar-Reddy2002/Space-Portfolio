...
const HeroContent = () => {
  const handleDownloadResume = () => {
    ...
    downloadLink.download = "MadhukarResume.pdf";
  ...
  return (
    ...
    >
      <div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-start">
        ...
        <motion.a variants={slideInFromLeft(1)} className="py-2 button-primary text-center text-white cursor-pointer rounded-lg max-w-[200px]" onClick={handleDownloadResume}>
          My Resume
        </motion.a>
      </div>
